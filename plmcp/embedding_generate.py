...
def esm_embedding_generate(fasta, embedding_path = None, esm_model_path = '/home/data/t030413/.cache/torch/hub/checkpoints/esm1b_t33_650M_UR50S.pt', nogpu = False,window=300, shift=100):
    ...
    data_loader = torch.utils.data.DataLoader(
        dataset, collate_fn=alphabet.get_batch_converter(10000), batch_sampler=batches,shuffle=False #huyue
    )
