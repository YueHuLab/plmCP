        ...
        for single_CP_query in tqdm(query_CP_sequences, desc="Query"):
            for single_target in target_sequences:
                ...
                if (output_path != None):
                    ...
                    protein_CP_pair_dict[single_CP_query].append((single_target, CPscore))
            for single_CP_target in target_CP_sequences:
                CPscore_tCP2, CPresults_tCP2,CPalnlen_tCP2,rowIndex_tCP2,scoreAll_tCP2 = pairwise_align(query_CP_embeddings[single_CP_query], target_CP_embeddings[single_CP_target], query_CP_sequences[single_CP_query], target_CP_sequences[single_CP_target], mode, method = method)
